...
var REG_PATCH = {
    Venusaur: { types: ['Grass', 'Fairy'], bs: { hp: 80, at: 66, df: 98, sa: 111, sd: 100, sp: 70 }, abilities: { 0: 'Misty Surge' } },
    Charizard: { types: ['Fire', 'Dark'], bs: { hp: 68, at: 120, df: 89, sa: 60, sd: 87, sp: 109 }, abilities: { 0: 'Levitate' } },
    Blastoise: { types: ['Water', 'Electric'], bs: { hp: 79, at: 53, df: 100, sa: 105, sd: 105, sp: 88 }, abilities: { 0: 'Motor Drive' } },
    Beedrill: { bs: { hp: 65, at: 100, df: 40, sa: 35, sd: 94, sp: 116 }, abilities: { 0: 'Poison Touch' } },
    Butterfree: { bs: { hp: 80, at: 45, df: 52, sa: 92, sd: 79, sp: 106 }, abilities: { 0: 'Tinted Lens' } },
    Pidgeot: { types: ['Flying'], bs: { hp: 83, at: 100, df: 75, sa: 50, sd: 70, sp: 112 }, abilities: { 0: 'Wings of Victory' } },
    Raticate: { types: ['Normal', 'Poison'], bs: { hp: 75, at: 90, df: 70, sa: 40, sd: 75, sp: 125 }, abilities: { 0: 'Guts' } },
    Nidoqueen: { bs: { hp: 100, at: 82, df: 87, sa: 95, sd: 85, sp: 76 }, abilities: { 0: 'Sheer Force' } },
    Nidoking: { bs: { hp: 81, at: 102, df: 82, sa: 95, sd: 70, sp: 95 }, abilities: { 0: 'Patriarch' } },
    Wigglytuff: { types: ['Fairy', 'Dark'], bs: { hp: 140, at: 75, df: 50, sa: 65, sd: 45, sp: 121 }, abilities: { 0: 'Levitate' } },
    Golbat: { bs: { hp: 80, at: 90, df: 70, sa: 55, sd: 70, sp: 115 }, abilities: { 0: 'Infiltrator' }, nfe: false },
    Alakazam: { bs: { hp: 80, at: 50, df: 50, sa: 110, sd: 110, sp: 110 }, abilities: { 0: 'Galaxy Brain' } },
    Tentacruel: { types: ['Dark', 'Poison'], bs: { hp: 80, at: 50, df: 65, sa: 100, sd: 120, sp: 100 }, abilities: { 0: 'Tropical Current' } },
    ...
    Marowak: { types: ['Ground', 'Ghost'], bs: { hp: 80, at: 80, df: 105, sa: 50, sd: 95, sp: 100 }, abilities: { 0: 'Battle Armor' } },
    Lickitung: { bs: { hp: 110, at: 90, df: 75, sa: 80, sd: 75, sp: 55 }, abilities: { 0: 'Analytic' }, nfe: false },
    Kangaskhan: { types: ['Normal', 'Dragon'], bs: { hp: 115, at: 110, df: 70, sa: 60, sd: 60, sp: 85 }, abilities: { 0: 'Bulletproof' } },
    Tangela: { types: ['Grass', 'Ground'], bs: { hp: 75, at: 55, df: 115, sa: 90, sd: 100, sp: 45 }, abilities: { 0: 'Vine Yard' }, nfe: false },
    Seadra: { types: ['Poison', 'Dragon'], bs: { hp: 80, at: 100, df: 95, sa: 100, sd: 70, sp: 85 }, abilities: { 0: 'Merciless' } },
    Gengar: { types: ['Ghost', 'Ice'], bs: { hp: 65, at: 65, df: 65, sa: 100, sd: 90, sp: 115 }, abilities: { 0: 'Blackout' } },
    Tauros: { types: ['Normal', 'Ground'], bs: { hp: 85, at: 110, df: 105, sa: 30, sd: 70, sp: 110 }, abilities: { 0: 'Bull Spirit' } },
    Gyarados: { bs: { hp: 100, at: 100, df: 107, sa: 70, sd: 92, sp: 71 }, abilities: { 0: 'Violent Abandon' } },
    Lapras: { abilities: { 0: 'Storm Drain' } },
    Vaporeon: { abilities: { 0: 'Protean' } },
    Jolteon: { bs: { hp: 65, at: 65, df: 60, sa: 95, sd: 110, sp: 130 }, abilities: { 0: 'Protean' } },
    Flareon: { bs: { hp: 110, at: 130, df: 60, sa: 65, sd: 65, sp: 95 }, abilities: { 0: 'Protean' } },
    Omastar: { bs: { hp: 73, at: 73, df: 151, sa: 95, sd: 77, sp: 101 }, abilities: { 0: 'Jurassic Dust' } },
    Kabutops: { types: ['Bug', 'Steel'], bs: { hp: 69, at: 117, df: 125, sa: 75, sd: 93, sp: 91 }, abilities: { 0: 'Jurassic Dust' } },
    Aerodactyl: { types: ['Rock', 'Dragon'], bs: { hp: 93, at: 109, df: 69, sa: 67, sd: 105, sp: 147 }, abilities: { 0: 'Jurassic Dust' } },
    Dragonite: { bs: { hp: 91, at: 134, df: 95, sa: 95, sd: 84, sp: 101 }, abilities: { 0: 'Lifeguard' } }
};
var SV = (0, util_1.extend)(true, {}, SS, SV_PATCH, PLA_PATCH, REG_PATCH);
